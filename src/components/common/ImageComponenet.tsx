 ...
 */
export const ImageComponent: FC<IImageComponentProps> = memo(({ src, alt }) => {
 ...
 */
export const ThumbnailComponent: FC<Required<IImageComponentProps>> = memo(({ src, navigatePath, alt }) => {
